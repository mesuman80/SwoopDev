...
@interface LoginViewController ()<UITextFieldDelegate,UIGestureRecognizerDelegate,CountryTableViewDelegate>
...
- (void)viewDidLoad {
    ...
    [self.tf_Country setText:[self countryCode]];
    [self.tf_Country setDelegate:self];
    self.tf_Country.textAlignment = NSTextAlignmentLeft;
    [self.tf_Country setUserInteractionEnabled:YES];
    [self.tf_Country endEditing:YES];
...
{
    [self addLeftViewsInTextfields:@[self.tf_Country,self.tf_Username, self.tf_Password] withImageNames:@[@"log_user_icon",@"log_user_icon",@"log_lock_icon"]];
}
...
-(void)setCountryCode:(NSString *)countryCode
{
    ...
    self.tf_Country.text = countryCode;
...
-(IBAction)openCountryView:(id)sender {
