...
{
    [self setImageWithResizeURL:stringUrl placeholderImage:placeholder options:kNilOptions completed:nil usingActivityIndicatorStyle:activityStyle];
}

- (void)setImageWithResizeURL:(NSString *)stringUrl placeholderImage:(UIImage *)placeholder completed:(SDWebImageCompletionBlock)completedBlock usingActivityIndicatorStyle:(UIActivityIndicatorViewStyle)activityStyle
{
    [self setImageWithResizeURL:stringUrl placeholderImage:placeholder options:kNilOptions completed:completedBlock usingActivityIndicatorStyle:activityStyle];
}

- (void)setImageWithResizeURL:(NSString *)stringUrl placeholderImage:(UIImage *)placeholder options:(SDWebImageOptions)options completed:(SDWebImageCompletionBlock)completionBlock usingActivityIndicatorStyle:(UIActivityIndicatorViewStyle)activityStyle
{
...
//    [self setImageWithURL:url placeholderImage:placeholder options:options usingActivityIndicatorStyle:activityStyle];
    [self setImageWithURL:url placeholderImage:placeholder options:options completed:completionBlock usingActivityIndicatorStyle:activityStyle];
}
