            ...
            if (self.moviePlayer) {
                ...
                if (!self.transitionImageView) {
                    ...
                    if (self.cellImageSnapshot.center.x > self.startCenter.x) {
                        newPoint.x = self.cellImageSnapshot.center.x + abs((int)(self.cellImageSnapshot.center.x -self.startCenter.x))*4;
                    }else{
                        newPoint.x = self.cellImageSnapshot.center.x - abs((int)(self.cellImageSnapshot.center.x -self.startCenter.x))*4;
                    }
                    if (self.cellImageSnapshot.center.y > self.startCenter.y) {
                        newPoint.y = self.cellImageSnapshot.center.y + abs((int)(self.cellImageSnapshot.center.y -self.startCenter.y))*4;
                    }else{
                        newPoint.y = self.cellImageSnapshot.center.y - abs((int)(self.cellImageSnapshot.center.y -self.startCenter.y))*4;
                    }
